...
public class TaxonomyTableMetadata extends TaxonomyItemTableMetadata {

  public TaxonomyTableMetadata(SchemaTableName table, RestCache<OpalConf> opalConfCache) {
