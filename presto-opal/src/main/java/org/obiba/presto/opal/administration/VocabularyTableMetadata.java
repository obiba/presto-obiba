...
public class VocabularyTableMetadata extends TaxonomyItemTableMetadata {

  public VocabularyTableMetadata(SchemaTableName table, RestCache<OpalConf> opalConfCache) {
